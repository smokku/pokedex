...
/**
 * PokemonV2MovemetaMinFieldsBase
 * auto generated base class for the model PokemonV2MovemetaMinFieldsModel.
 *
 * aggregate min on columns
 */
export const PokemonV2MovemetaMinFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaMinFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_min_fields"), "pokemon_v2_movemeta_min_fields"),
...
export class PokemonV2MovemetaMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaMinFields() {
  return new PokemonV2MovemetaMinFieldsModelSelector()
}

export const pokemonV2MovemetaMinFieldsModelPrimitives = selectFromPokemonV2MovemetaMinFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
