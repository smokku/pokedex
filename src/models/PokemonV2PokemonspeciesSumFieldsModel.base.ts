...
/**
 * PokemonV2PokemonspeciesSumFieldsBase
 * auto generated base class for the model PokemonV2PokemonspeciesSumFieldsModel.
 *
 * aggregate sum on columns
 */
export const PokemonV2PokemonspeciesSumFieldsModelBase = ModelBase
  .named('PokemonV2PokemonspeciesSumFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonspecies_sum_fields"), "pokemon_v2_pokemonspecies_sum_fields"),
...
export class PokemonV2PokemonspeciesSumFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonspeciesSumFields() {
  return new PokemonV2PokemonspeciesSumFieldsModelSelector()
}

export const pokemonV2PokemonspeciesSumFieldsModelPrimitives = selectFromPokemonV2PokemonspeciesSumFields().base_happiness.capture_rate.evolution_chain_id.evolves_from_species_id.gender_rate.generation_id.growth_rate_id.hatch_counter.order.pokemon_color_id.pokemon_habitat_id.pokemon_shape_id
