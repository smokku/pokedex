...
/**
 * PokemonV2MoveVarPopFieldsBase
 * auto generated base class for the model PokemonV2MoveVarPopFieldsModel.
 *
 * aggregate var_pop on columns
 */
export const PokemonV2MoveVarPopFieldsModelBase = ModelBase
  .named('PokemonV2MoveVarPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_var_pop_fields"), "pokemon_v2_move_var_pop_fields"),
...
export class PokemonV2MoveVarPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveVarPopFields() {
  return new PokemonV2MoveVarPopFieldsModelSelector()
}

export const pokemonV2MoveVarPopFieldsModelPrimitives = selectFromPokemonV2MoveVarPopFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.power.pp.priority.super_contest_effect_id.type_id
