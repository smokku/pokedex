...
/**
 * PokemonV2MovemetaStddevFieldsBase
 * auto generated base class for the model PokemonV2MovemetaStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const PokemonV2MovemetaStddevFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaStddevFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_stddev_fields"), "pokemon_v2_movemeta_stddev_fields"),
...
export class PokemonV2MovemetaStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaStddevFields() {
  return new PokemonV2MovemetaStddevFieldsModelSelector()
}

export const pokemonV2MovemetaStddevFieldsModelPrimitives = selectFromPokemonV2MovemetaStddevFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
