...
/**
 * PokemonV2BerryVarianceFieldsBase
 * auto generated base class for the model PokemonV2BerryVarianceFieldsModel.
 *
 * aggregate variance on columns
 */
export const PokemonV2BerryVarianceFieldsModelBase = ModelBase
  .named('PokemonV2BerryVarianceFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_berry_variance_fields"), "pokemon_v2_berry_variance_fields"),
...
export class PokemonV2BerryVarianceFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2BerryVarianceFields() {
  return new PokemonV2BerryVarianceFieldsModelSelector()
}

export const pokemonV2BerryVarianceFieldsModelPrimitives = selectFromPokemonV2BerryVarianceFields().berry_firmness_id.growth_time.item_id.max_harvest.natural_gift_power.natural_gift_type_id.size.smoothness.soil_dryness
