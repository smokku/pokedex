...
/**
 * PokemonV2MoveSumFieldsBase
 * auto generated base class for the model PokemonV2MoveSumFieldsModel.
 *
 * aggregate sum on columns
 */
export const PokemonV2MoveSumFieldsModelBase = ModelBase
  .named('PokemonV2MoveSumFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_sum_fields"), "pokemon_v2_move_sum_fields"),
...
export class PokemonV2MoveSumFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveSumFields() {
  return new PokemonV2MoveSumFieldsModelSelector()
}

export const pokemonV2MoveSumFieldsModelPrimitives = selectFromPokemonV2MoveSumFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.power.pp.priority.super_contest_effect_id.type_id
