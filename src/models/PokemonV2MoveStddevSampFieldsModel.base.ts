...
/**
 * PokemonV2MoveStddevSampFieldsBase
 * auto generated base class for the model PokemonV2MoveStddevSampFieldsModel.
 *
 * aggregate stddev_samp on columns
 */
export const PokemonV2MoveStddevSampFieldsModelBase = ModelBase
  .named('PokemonV2MoveStddevSampFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_stddev_samp_fields"), "pokemon_v2_move_stddev_samp_fields"),
...
export class PokemonV2MoveStddevSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveStddevSampFields() {
  return new PokemonV2MoveStddevSampFieldsModelSelector()
}

export const pokemonV2MoveStddevSampFieldsModelPrimitives = selectFromPokemonV2MoveStddevSampFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.power.pp.priority.super_contest_effect_id.type_id
