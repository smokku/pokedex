...
/**
 * PokemonV2PokemonspeciesVarSampFieldsBase
 * auto generated base class for the model PokemonV2PokemonspeciesVarSampFieldsModel.
 *
 * aggregate var_samp on columns
 */
export const PokemonV2PokemonspeciesVarSampFieldsModelBase = ModelBase
  .named('PokemonV2PokemonspeciesVarSampFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonspecies_var_samp_fields"), "pokemon_v2_pokemonspecies_var_samp_fields"),
...
export class PokemonV2PokemonspeciesVarSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonspeciesVarSampFields() {
  return new PokemonV2PokemonspeciesVarSampFieldsModelSelector()
}

export const pokemonV2PokemonspeciesVarSampFieldsModelPrimitives = selectFromPokemonV2PokemonspeciesVarSampFields().base_happiness.capture_rate.evolution_chain_id.evolves_from_species_id.gender_rate.generation_id.growth_rate_id.hatch_counter.order.pokemon_color_id.pokemon_habitat_id.pokemon_shape_id
