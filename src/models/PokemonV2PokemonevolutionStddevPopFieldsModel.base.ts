...
/**
 * PokemonV2PokemonevolutionStddevPopFieldsBase
 * auto generated base class for the model PokemonV2PokemonevolutionStddevPopFieldsModel.
 *
 * aggregate stddev_pop on columns
 */
export const PokemonV2PokemonevolutionStddevPopFieldsModelBase = ModelBase
  .named('PokemonV2PokemonevolutionStddevPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonevolution_stddev_pop_fields"), "pokemon_v2_pokemonevolution_stddev_pop_fields"),
...
export class PokemonV2PokemonevolutionStddevPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonevolutionStddevPopFields() {
  return new PokemonV2PokemonevolutionStddevPopFieldsModelSelector()
}

export const pokemonV2PokemonevolutionStddevPopFieldsModelPrimitives = selectFromPokemonV2PokemonevolutionStddevPopFields().evolution_item_id.evolution_trigger_id.evolved_species_id.gender_id.held_item_id.known_move_id.known_move_type_id.location_id.min_affection.min_beauty.min_happiness.min_level.party_species_id.party_type_id.relative_physical_stats.trade_species_id
