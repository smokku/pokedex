...
/**
 * PokemonV2PokemonspeciesAvgFieldsBase
 * auto generated base class for the model PokemonV2PokemonspeciesAvgFieldsModel.
 *
 * aggregate avg on columns
 */
export const PokemonV2PokemonspeciesAvgFieldsModelBase = ModelBase
  .named('PokemonV2PokemonspeciesAvgFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonspecies_avg_fields"), "pokemon_v2_pokemonspecies_avg_fields"),
...
export class PokemonV2PokemonspeciesAvgFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonspeciesAvgFields() {
  return new PokemonV2PokemonspeciesAvgFieldsModelSelector()
}

export const pokemonV2PokemonspeciesAvgFieldsModelPrimitives = selectFromPokemonV2PokemonspeciesAvgFields().base_happiness.capture_rate.evolution_chain_id.evolves_from_species_id.gender_rate.generation_id.growth_rate_id.hatch_counter.order.pokemon_color_id.pokemon_habitat_id.pokemon_shape_id
