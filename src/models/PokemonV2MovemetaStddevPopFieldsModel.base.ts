...
/**
 * PokemonV2MovemetaStddevPopFieldsBase
 * auto generated base class for the model PokemonV2MovemetaStddevPopFieldsModel.
 *
 * aggregate stddev_pop on columns
 */
export const PokemonV2MovemetaStddevPopFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaStddevPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_stddev_pop_fields"), "pokemon_v2_movemeta_stddev_pop_fields"),
...
export class PokemonV2MovemetaStddevPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaStddevPopFields() {
  return new PokemonV2MovemetaStddevPopFieldsModelSelector()
}

export const pokemonV2MovemetaStddevPopFieldsModelPrimitives = selectFromPokemonV2MovemetaStddevPopFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
