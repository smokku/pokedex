...
/**
 * PokemonV2MoveAvgFieldsBase
 * auto generated base class for the model PokemonV2MoveAvgFieldsModel.
 *
 * aggregate avg on columns
 */
export const PokemonV2MoveAvgFieldsModelBase = ModelBase
  .named('PokemonV2MoveAvgFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_avg_fields"), "pokemon_v2_move_avg_fields"),
...
export class PokemonV2MoveAvgFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveAvgFields() {
  return new PokemonV2MoveAvgFieldsModelSelector()
}

export const pokemonV2MoveAvgFieldsModelPrimitives = selectFromPokemonV2MoveAvgFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.power.pp.priority.super_contest_effect_id.type_id
