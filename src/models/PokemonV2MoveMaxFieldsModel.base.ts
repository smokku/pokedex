...
/**
 * PokemonV2MoveMaxFieldsBase
 * auto generated base class for the model PokemonV2MoveMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const PokemonV2MoveMaxFieldsModelBase = ModelBase
  .named('PokemonV2MoveMaxFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_max_fields"), "pokemon_v2_move_max_fields"),
...
export class PokemonV2MoveMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveMaxFields() {
  return new PokemonV2MoveMaxFieldsModelSelector()
}

export const pokemonV2MoveMaxFieldsModelPrimitives = selectFromPokemonV2MoveMaxFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.name.power.pp.priority.super_contest_effect_id.type_id
