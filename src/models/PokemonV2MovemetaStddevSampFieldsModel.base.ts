...
/**
 * PokemonV2MovemetaStddevSampFieldsBase
 * auto generated base class for the model PokemonV2MovemetaStddevSampFieldsModel.
 *
 * aggregate stddev_samp on columns
 */
export const PokemonV2MovemetaStddevSampFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaStddevSampFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_stddev_samp_fields"), "pokemon_v2_movemeta_stddev_samp_fields"),
...
export class PokemonV2MovemetaStddevSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaStddevSampFields() {
  return new PokemonV2MovemetaStddevSampFieldsModelSelector()
}

export const pokemonV2MovemetaStddevSampFieldsModelPrimitives = selectFromPokemonV2MovemetaStddevSampFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
