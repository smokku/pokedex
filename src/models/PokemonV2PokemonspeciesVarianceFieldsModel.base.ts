...
/**
 * PokemonV2PokemonspeciesVarianceFieldsBase
 * auto generated base class for the model PokemonV2PokemonspeciesVarianceFieldsModel.
 *
 * aggregate variance on columns
 */
export const PokemonV2PokemonspeciesVarianceFieldsModelBase = ModelBase
  .named('PokemonV2PokemonspeciesVarianceFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonspecies_variance_fields"), "pokemon_v2_pokemonspecies_variance_fields"),
...
export class PokemonV2PokemonspeciesVarianceFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonspeciesVarianceFields() {
  return new PokemonV2PokemonspeciesVarianceFieldsModelSelector()
}

export const pokemonV2PokemonspeciesVarianceFieldsModelPrimitives = selectFromPokemonV2PokemonspeciesVarianceFields().base_happiness.capture_rate.evolution_chain_id.evolves_from_species_id.gender_rate.generation_id.growth_rate_id.hatch_counter.order.pokemon_color_id.pokemon_habitat_id.pokemon_shape_id
