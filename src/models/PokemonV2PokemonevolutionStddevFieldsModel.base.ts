...
/**
 * PokemonV2PokemonevolutionStddevFieldsBase
 * auto generated base class for the model PokemonV2PokemonevolutionStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const PokemonV2PokemonevolutionStddevFieldsModelBase = ModelBase
  .named('PokemonV2PokemonevolutionStddevFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonevolution_stddev_fields"), "pokemon_v2_pokemonevolution_stddev_fields"),
...
export class PokemonV2PokemonevolutionStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonevolutionStddevFields() {
  return new PokemonV2PokemonevolutionStddevFieldsModelSelector()
}

export const pokemonV2PokemonevolutionStddevFieldsModelPrimitives = selectFromPokemonV2PokemonevolutionStddevFields().evolution_item_id.evolution_trigger_id.evolved_species_id.gender_id.held_item_id.known_move_id.known_move_type_id.location_id.min_affection.min_beauty.min_happiness.min_level.party_species_id.party_type_id.relative_physical_stats.trade_species_id
