...
/**
 * PokemonV2MovechangeSumFieldsBase
 * auto generated base class for the model PokemonV2MovechangeSumFieldsModel.
 *
 * aggregate sum on columns
 */
export const PokemonV2MovechangeSumFieldsModelBase = ModelBase
  .named('PokemonV2MovechangeSumFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movechange_sum_fields"), "pokemon_v2_movechange_sum_fields"),
...
export class PokemonV2MovechangeSumFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovechangeSumFields() {
  return new PokemonV2MovechangeSumFieldsModelSelector()
}

export const pokemonV2MovechangeSumFieldsModelPrimitives = selectFromPokemonV2MovechangeSumFields().accuracy.move_effect_chance.move_effect_id.move_id.power.pp.type_id.version_group_id
