...
/**
 * PokemonV2BerryStddevFieldsBase
 * auto generated base class for the model PokemonV2BerryStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const PokemonV2BerryStddevFieldsModelBase = ModelBase
  .named('PokemonV2BerryStddevFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_berry_stddev_fields"), "pokemon_v2_berry_stddev_fields"),
...
export class PokemonV2BerryStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2BerryStddevFields() {
  return new PokemonV2BerryStddevFieldsModelSelector()
}

export const pokemonV2BerryStddevFieldsModelPrimitives = selectFromPokemonV2BerryStddevFields().berry_firmness_id.growth_time.item_id.max_harvest.natural_gift_power.natural_gift_type_id.size.smoothness.soil_dryness
