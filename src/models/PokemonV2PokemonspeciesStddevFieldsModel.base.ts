...
/**
 * PokemonV2PokemonspeciesStddevFieldsBase
 * auto generated base class for the model PokemonV2PokemonspeciesStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const PokemonV2PokemonspeciesStddevFieldsModelBase = ModelBase
  .named('PokemonV2PokemonspeciesStddevFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonspecies_stddev_fields"), "pokemon_v2_pokemonspecies_stddev_fields"),
...
export class PokemonV2PokemonspeciesStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonspeciesStddevFields() {
  return new PokemonV2PokemonspeciesStddevFieldsModelSelector()
}

export const pokemonV2PokemonspeciesStddevFieldsModelPrimitives = selectFromPokemonV2PokemonspeciesStddevFields().base_happiness.capture_rate.evolution_chain_id.evolves_from_species_id.gender_rate.generation_id.growth_rate_id.hatch_counter.order.pokemon_color_id.pokemon_habitat_id.pokemon_shape_id
