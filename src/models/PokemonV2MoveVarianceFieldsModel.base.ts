...
/**
 * PokemonV2MoveVarianceFieldsBase
 * auto generated base class for the model PokemonV2MoveVarianceFieldsModel.
 *
 * aggregate variance on columns
 */
export const PokemonV2MoveVarianceFieldsModelBase = ModelBase
  .named('PokemonV2MoveVarianceFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_variance_fields"), "pokemon_v2_move_variance_fields"),
...
export class PokemonV2MoveVarianceFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveVarianceFields() {
  return new PokemonV2MoveVarianceFieldsModelSelector()
}

export const pokemonV2MoveVarianceFieldsModelPrimitives = selectFromPokemonV2MoveVarianceFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.power.pp.priority.super_contest_effect_id.type_id
