...
/**
 * PokemonV2MoveStddevFieldsBase
 * auto generated base class for the model PokemonV2MoveStddevFieldsModel.
 *
 * aggregate stddev on columns
 */
export const PokemonV2MoveStddevFieldsModelBase = ModelBase
  .named('PokemonV2MoveStddevFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_stddev_fields"), "pokemon_v2_move_stddev_fields"),
...
export class PokemonV2MoveStddevFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveStddevFields() {
  return new PokemonV2MoveStddevFieldsModelSelector()
}

export const pokemonV2MoveStddevFieldsModelPrimitives = selectFromPokemonV2MoveStddevFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.power.pp.priority.super_contest_effect_id.type_id
