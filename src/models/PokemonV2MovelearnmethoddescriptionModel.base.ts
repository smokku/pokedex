...
/**
 * PokemonV2MovelearnmethoddescriptionBase
 * auto generated base class for the model PokemonV2MovelearnmethoddescriptionModel.
 *
 * columns and relationships of "pokemon_v2_movelearnmethoddescription"
 */
export const PokemonV2MovelearnmethoddescriptionModelBase = ModelBase
  .named('PokemonV2Movelearnmethoddescription')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movelearnmethoddescription"), "pokemon_v2_movelearnmethoddescription"),
...
export class PokemonV2MovelearnmethoddescriptionModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2Movelearnmethoddescription() {
  return new PokemonV2MovelearnmethoddescriptionModelSelector()
}

export const pokemonV2MovelearnmethoddescriptionModelPrimitives = selectFromPokemonV2Movelearnmethoddescription().description.language_id.move_learn_method_id
