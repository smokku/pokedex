...
/**
 * PokemonV2BerryStddevPopFieldsBase
 * auto generated base class for the model PokemonV2BerryStddevPopFieldsModel.
 *
 * aggregate stddev_pop on columns
 */
export const PokemonV2BerryStddevPopFieldsModelBase = ModelBase
  .named('PokemonV2BerryStddevPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_berry_stddev_pop_fields"), "pokemon_v2_berry_stddev_pop_fields"),
...
export class PokemonV2BerryStddevPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2BerryStddevPopFields() {
  return new PokemonV2BerryStddevPopFieldsModelSelector()
}

export const pokemonV2BerryStddevPopFieldsModelPrimitives = selectFromPokemonV2BerryStddevPopFields().berry_firmness_id.growth_time.item_id.max_harvest.natural_gift_power.natural_gift_type_id.size.smoothness.soil_dryness
