...
/**
 * PokemonV2PokemonspeciesMinFieldsBase
 * auto generated base class for the model PokemonV2PokemonspeciesMinFieldsModel.
 *
 * aggregate min on columns
 */
export const PokemonV2PokemonspeciesMinFieldsModelBase = ModelBase
  .named('PokemonV2PokemonspeciesMinFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonspecies_min_fields"), "pokemon_v2_pokemonspecies_min_fields"),
...
export class PokemonV2PokemonspeciesMinFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonspeciesMinFields() {
  return new PokemonV2PokemonspeciesMinFieldsModelSelector()
}

export const pokemonV2PokemonspeciesMinFieldsModelPrimitives = selectFromPokemonV2PokemonspeciesMinFields().base_happiness.capture_rate.evolution_chain_id.evolves_from_species_id.gender_rate.generation_id.growth_rate_id.hatch_counter.name.order.pokemon_color_id.pokemon_habitat_id.pokemon_shape_id
