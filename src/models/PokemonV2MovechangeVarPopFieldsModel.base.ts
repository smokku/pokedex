...
/**
 * PokemonV2MovechangeVarPopFieldsBase
 * auto generated base class for the model PokemonV2MovechangeVarPopFieldsModel.
 *
 * aggregate var_pop on columns
 */
export const PokemonV2MovechangeVarPopFieldsModelBase = ModelBase
  .named('PokemonV2MovechangeVarPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movechange_var_pop_fields"), "pokemon_v2_movechange_var_pop_fields"),
...
export class PokemonV2MovechangeVarPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovechangeVarPopFields() {
  return new PokemonV2MovechangeVarPopFieldsModelSelector()
}

export const pokemonV2MovechangeVarPopFieldsModelPrimitives = selectFromPokemonV2MovechangeVarPopFields().accuracy.move_effect_chance.move_effect_id.move_id.power.pp.type_id.version_group_id
