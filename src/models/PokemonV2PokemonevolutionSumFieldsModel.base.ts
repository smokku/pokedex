...
/**
 * PokemonV2PokemonevolutionSumFieldsBase
 * auto generated base class for the model PokemonV2PokemonevolutionSumFieldsModel.
 *
 * aggregate sum on columns
 */
export const PokemonV2PokemonevolutionSumFieldsModelBase = ModelBase
  .named('PokemonV2PokemonevolutionSumFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonevolution_sum_fields"), "pokemon_v2_pokemonevolution_sum_fields"),
...
export class PokemonV2PokemonevolutionSumFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonevolutionSumFields() {
  return new PokemonV2PokemonevolutionSumFieldsModelSelector()
}

export const pokemonV2PokemonevolutionSumFieldsModelPrimitives = selectFromPokemonV2PokemonevolutionSumFields().evolution_item_id.evolution_trigger_id.evolved_species_id.gender_id.held_item_id.known_move_id.known_move_type_id.location_id.min_affection.min_beauty.min_happiness.min_level.party_species_id.party_type_id.relative_physical_stats.trade_species_id
