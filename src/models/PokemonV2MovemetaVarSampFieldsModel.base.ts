...
/**
 * PokemonV2MovemetaVarSampFieldsBase
 * auto generated base class for the model PokemonV2MovemetaVarSampFieldsModel.
 *
 * aggregate var_samp on columns
 */
export const PokemonV2MovemetaVarSampFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaVarSampFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_var_samp_fields"), "pokemon_v2_movemeta_var_samp_fields"),
...
export class PokemonV2MovemetaVarSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaVarSampFields() {
  return new PokemonV2MovemetaVarSampFieldsModelSelector()
}

export const pokemonV2MovemetaVarSampFieldsModelPrimitives = selectFromPokemonV2MovemetaVarSampFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
