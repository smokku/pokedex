...
/**
 * PokemonV2PokemonevolutionVarSampFieldsBase
 * auto generated base class for the model PokemonV2PokemonevolutionVarSampFieldsModel.
 *
 * aggregate var_samp on columns
 */
export const PokemonV2PokemonevolutionVarSampFieldsModelBase = ModelBase
  .named('PokemonV2PokemonevolutionVarSampFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonevolution_var_samp_fields"), "pokemon_v2_pokemonevolution_var_samp_fields"),
...
export class PokemonV2PokemonevolutionVarSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonevolutionVarSampFields() {
  return new PokemonV2PokemonevolutionVarSampFieldsModelSelector()
}

export const pokemonV2PokemonevolutionVarSampFieldsModelPrimitives = selectFromPokemonV2PokemonevolutionVarSampFields().evolution_item_id.evolution_trigger_id.evolved_species_id.gender_id.held_item_id.known_move_id.known_move_type_id.location_id.min_affection.min_beauty.min_happiness.min_level.party_species_id.party_type_id.relative_physical_stats.trade_species_id
