...
/**
 * PokemonV2PokemonevolutionMaxFieldsBase
 * auto generated base class for the model PokemonV2PokemonevolutionMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const PokemonV2PokemonevolutionMaxFieldsModelBase = ModelBase
  .named('PokemonV2PokemonevolutionMaxFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonevolution_max_fields"), "pokemon_v2_pokemonevolution_max_fields"),
...
export class PokemonV2PokemonevolutionMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonevolutionMaxFields() {
  return new PokemonV2PokemonevolutionMaxFieldsModelSelector()
}

export const pokemonV2PokemonevolutionMaxFieldsModelPrimitives = selectFromPokemonV2PokemonevolutionMaxFields().evolution_item_id.evolution_trigger_id.evolved_species_id.gender_id.held_item_id.known_move_id.known_move_type_id.location_id.min_affection.min_beauty.min_happiness.min_level.party_species_id.party_type_id.relative_physical_stats.time_of_day.trade_species_id
