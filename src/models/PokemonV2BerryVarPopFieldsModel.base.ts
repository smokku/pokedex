...
/**
 * PokemonV2BerryVarPopFieldsBase
 * auto generated base class for the model PokemonV2BerryVarPopFieldsModel.
 *
 * aggregate var_pop on columns
 */
export const PokemonV2BerryVarPopFieldsModelBase = ModelBase
  .named('PokemonV2BerryVarPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_berry_var_pop_fields"), "pokemon_v2_berry_var_pop_fields"),
...
export class PokemonV2BerryVarPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2BerryVarPopFields() {
  return new PokemonV2BerryVarPopFieldsModelSelector()
}

export const pokemonV2BerryVarPopFieldsModelPrimitives = selectFromPokemonV2BerryVarPopFields().berry_firmness_id.growth_time.item_id.max_harvest.natural_gift_power.natural_gift_type_id.size.smoothness.soil_dryness
