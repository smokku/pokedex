...
/**
 * PokemonV2MovedamageclassnameBase
 * auto generated base class for the model PokemonV2MovedamageclassnameModel.
 *
 * columns and relationships of "pokemon_v2_movedamageclassname"
 */
export const PokemonV2MovedamageclassnameModelBase = ModelBase
  .named('PokemonV2Movedamageclassname')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movedamageclassname"), "pokemon_v2_movedamageclassname"),
...
export class PokemonV2MovedamageclassnameModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2Movedamageclassname() {
  return new PokemonV2MovedamageclassnameModelSelector()
}

export const pokemonV2MovedamageclassnameModelPrimitives = selectFromPokemonV2Movedamageclassname().language_id.move_damage_class_id.name
