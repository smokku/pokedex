...
/**
 * PokemonV2PokemonspeciesStddevPopFieldsBase
 * auto generated base class for the model PokemonV2PokemonspeciesStddevPopFieldsModel.
 *
 * aggregate stddev_pop on columns
 */
export const PokemonV2PokemonspeciesStddevPopFieldsModelBase = ModelBase
  .named('PokemonV2PokemonspeciesStddevPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonspecies_stddev_pop_fields"), "pokemon_v2_pokemonspecies_stddev_pop_fields"),
...
export class PokemonV2PokemonspeciesStddevPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonspeciesStddevPopFields() {
  return new PokemonV2PokemonspeciesStddevPopFieldsModelSelector()
}

export const pokemonV2PokemonspeciesStddevPopFieldsModelPrimitives = selectFromPokemonV2PokemonspeciesStddevPopFields().base_happiness.capture_rate.evolution_chain_id.evolves_from_species_id.gender_rate.generation_id.growth_rate_id.hatch_counter.order.pokemon_color_id.pokemon_habitat_id.pokemon_shape_id
