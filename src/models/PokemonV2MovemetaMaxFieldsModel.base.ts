...
/**
 * PokemonV2MovemetaMaxFieldsBase
 * auto generated base class for the model PokemonV2MovemetaMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const PokemonV2MovemetaMaxFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaMaxFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_max_fields"), "pokemon_v2_movemeta_max_fields"),
...
export class PokemonV2MovemetaMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaMaxFields() {
  return new PokemonV2MovemetaMaxFieldsModelSelector()
}

export const pokemonV2MovemetaMaxFieldsModelPrimitives = selectFromPokemonV2MovemetaMaxFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
