...
/**
 * PokemonV2MovemetaAvgFieldsBase
 * auto generated base class for the model PokemonV2MovemetaAvgFieldsModel.
 *
 * aggregate avg on columns
 */
export const PokemonV2MovemetaAvgFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaAvgFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_avg_fields"), "pokemon_v2_movemeta_avg_fields"),
...
export class PokemonV2MovemetaAvgFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaAvgFields() {
  return new PokemonV2MovemetaAvgFieldsModelSelector()
}

export const pokemonV2MovemetaAvgFieldsModelPrimitives = selectFromPokemonV2MovemetaAvgFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
