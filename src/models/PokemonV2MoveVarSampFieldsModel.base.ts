...
/**
 * PokemonV2MoveVarSampFieldsBase
 * auto generated base class for the model PokemonV2MoveVarSampFieldsModel.
 *
 * aggregate var_samp on columns
 */
export const PokemonV2MoveVarSampFieldsModelBase = ModelBase
  .named('PokemonV2MoveVarSampFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_move_var_samp_fields"), "pokemon_v2_move_var_samp_fields"),
...
export class PokemonV2MoveVarSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MoveVarSampFields() {
  return new PokemonV2MoveVarSampFieldsModelSelector()
}

export const pokemonV2MoveVarSampFieldsModelPrimitives = selectFromPokemonV2MoveVarSampFields().accuracy.contest_effect_id.contest_type_id.generation_id.move_damage_class_id.move_effect_chance.move_effect_id.move_target_id.power.pp.priority.super_contest_effect_id.type_id
