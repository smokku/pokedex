...
/**
 * PokemonV2MovemetaVarPopFieldsBase
 * auto generated base class for the model PokemonV2MovemetaVarPopFieldsModel.
 *
 * aggregate var_pop on columns
 */
export const PokemonV2MovemetaVarPopFieldsModelBase = ModelBase
  .named('PokemonV2MovemetaVarPopFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_movemeta_var_pop_fields"), "pokemon_v2_movemeta_var_pop_fields"),
...
export class PokemonV2MovemetaVarPopFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2MovemetaVarPopFields() {
  return new PokemonV2MovemetaVarPopFieldsModelSelector()
}

export const pokemonV2MovemetaVarPopFieldsModelPrimitives = selectFromPokemonV2MovemetaVarPopFields().ailment_chance.crit_rate.drain.flinch_chance.healing.max_hits.max_turns.min_hits.min_turns.move_id.move_meta_ailment_id.move_meta_category_id.stat_chance
