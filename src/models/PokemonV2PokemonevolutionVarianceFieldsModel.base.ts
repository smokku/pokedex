...
/**
 * PokemonV2PokemonevolutionVarianceFieldsBase
 * auto generated base class for the model PokemonV2PokemonevolutionVarianceFieldsModel.
 *
 * aggregate variance on columns
 */
export const PokemonV2PokemonevolutionVarianceFieldsModelBase = ModelBase
  .named('PokemonV2PokemonevolutionVarianceFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonevolution_variance_fields"), "pokemon_v2_pokemonevolution_variance_fields"),
...
export class PokemonV2PokemonevolutionVarianceFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonevolutionVarianceFields() {
  return new PokemonV2PokemonevolutionVarianceFieldsModelSelector()
}

export const pokemonV2PokemonevolutionVarianceFieldsModelPrimitives = selectFromPokemonV2PokemonevolutionVarianceFields().evolution_item_id.evolution_trigger_id.evolved_species_id.gender_id.held_item_id.known_move_id.known_move_type_id.location_id.min_affection.min_beauty.min_happiness.min_level.party_species_id.party_type_id.relative_physical_stats.trade_species_id
