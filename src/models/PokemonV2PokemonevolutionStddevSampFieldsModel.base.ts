...
/**
 * PokemonV2PokemonevolutionStddevSampFieldsBase
 * auto generated base class for the model PokemonV2PokemonevolutionStddevSampFieldsModel.
 *
 * aggregate stddev_samp on columns
 */
export const PokemonV2PokemonevolutionStddevSampFieldsModelBase = ModelBase
  .named('PokemonV2PokemonevolutionStddevSampFields')
  .props({
    __typename: types.optional(types.literal("pokemon_v2_pokemonevolution_stddev_samp_fields"), "pokemon_v2_pokemonevolution_stddev_samp_fields"),
...
export class PokemonV2PokemonevolutionStddevSampFieldsModelSelector extends QueryBuilder {
...
export function selectFromPokemonV2PokemonevolutionStddevSampFields() {
  return new PokemonV2PokemonevolutionStddevSampFieldsModelSelector()
}

export const pokemonV2PokemonevolutionStddevSampFieldsModelPrimitives = selectFromPokemonV2PokemonevolutionStddevSampFields().evolution_item_id.evolution_trigger_id.evolved_species_id.gender_id.held_item_id.known_move_id.known_move_type_id.location_id.min_affection.min_beauty.min_happiness.min_level.party_species_id.party_type_id.relative_physical_stats.trade_species_id
